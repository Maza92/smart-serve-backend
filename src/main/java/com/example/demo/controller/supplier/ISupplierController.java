...
public interface ISupplierController {
        ...
        @Operation(summary = "Get all suppliers", description = "Get all suppliers with pagination and sorting", security = {
        ...
        @Operation(summary = "Get supplier by ID", description = "Get supplier by ID", security = {
                        @SecurityRequirement(name = "bearer-key") })
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(schema = @Schema(implementation = ApiSuccessDto.class))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
        ...
        @Operation(summary = "Create supplier", description = "Create a new supplier", security = {
                        @SecurityRequirement(name = "bearer-key") })
        @ApiResponses(value = {
        ...
        @Operation(summary = "Update supplier", description = "Update an existing supplier", security = {
                        @SecurityRequirement(name = "bearer-key") })
        @ApiResponses(value = {
        ...
        @Operation(summary = "Delete supplier", description = "Delete an existing supplier", security = {
                        @SecurityRequirement(name = "bearer-key") })
        @ApiResponses(value = {
